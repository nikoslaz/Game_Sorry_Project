...
/**
 * The SlideSquare class represents a slide square in the board of the game.
 * @author Nikolas Lazaridis
 * @version 1.0
 */
public class SlideSquare implements Square{
     ...
     */
    public SlideSquare(int position, String color, boolean isOccupied) {
