...
/**
 * There is one such position for each player. At this position, the player places his initial 2 pawns.
 * The start position is located at the beginning of the safety zone. A pawn can move out of the start position
 * only if the player draws a 1 or 2 card. If a player draws a 1 or 2 card, he can move one of his pawns
 * from the start position to the first square of the safety zone. If the player draws a 1 or 2 card
 * and, he has no pawns at the start position, then he loses his turn.
...
public class StartSquare implements Square {
     ...
     */
    public StartSquare(int position, String color, boolean isOccupied) {
